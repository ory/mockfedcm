...
const GenericPageLayout = ({
  ...
  return (
    ...
    >
      <div className="w-full h-full max-w-[1536px] border-l border-r border-gray-300 flex flex-col justify-start items-start gap-12 overflow-hidden">
        ...
        <div className="self-stretch flex-1 flex flex-col md:flex-row justify-start items-start w-full h-full overflow-hidden">
          <div className="w-full md:flex-1 md:order-2 h-full px-4 md:px-8 flex flex-col justify-start items-center gap-8 border-b md:border-b-0 md:border-l border-gray-300 lg:overflow-y-auto overflow-hidden">
            {FormContent && <FormContent {...formContentProps} />}
          </div>

          <div className="w-full md:flex-1 md:order-1 h-full py-8 md:py-32 bg-gray-50 flex flex-col justify-start items-center gap-4 border border-gray-300 lg:overflow-y-auto overflow-hidden">
